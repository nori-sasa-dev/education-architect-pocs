...
**AI × 教育 × 経営** の3軸でPOCアプリを開発するポートフォリオ。
...
| # | アプリ名 | 概要 | 技術 |
|---|---------|------|------|
| ① | [スキル棚卸しチャットボット](pocs/skill_inventory_bot/) | 対話形式でスキルを言語化するチャットBot | Python / Streamlit / Claude API |
...
AI × 教育 × 経営の掛け合わせで、学びの体験を再設計することがビジョンです。
